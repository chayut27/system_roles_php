                        ...
                        <div class="card-body">
                            ...
                            <form action="save-user.php?act=update&user_id=<?php echo $data_user["id"]; ?>" method="POST" class="row gy-3">
                                <div class="col-12">
                                    ...
                                    <select name="role_id" id="role_id" class="form-select" required>
                                        ...
                                        <?php foreach ($arr_roles as $row) { ?>
                                            <option value="<?php echo $row["id"]; ?>" <?php if ($data_user["role_id"] == $row["id"]) {
                                                                                            echo "selected";
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="position_id" id="position_id" class="form-select" required>
                                            ...
                                            <?php foreach ($arr_positions as $row) { ?>
                                                <option value="<?php echo $row["id"]; ?>" <?php if ($data_user["position_id"] == $row["id"]) {
                                                                                                echo "selected";
                                                                                            } ?>><?php echo $row["name"]; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control" value="<?php echo $data_user["username"]; ?>" required>
                                </div>
                                <div class="col-12">
